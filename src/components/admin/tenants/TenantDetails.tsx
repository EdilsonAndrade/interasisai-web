      ...
      <header className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        {active && (
          <div className="flex gap-2">
            ...
            <button type="button" onClick={onDelete} className="inline-flex items-center gap-2 rounded-card border border-red-400/50 px-3 py-2 text-sm font-semibold text-red-300 hover:bg-red-500/10">
